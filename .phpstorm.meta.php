...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\wamp64\www\Internship project\intellmeet\public\storage' => 'string',
            ...
            'reverb.apps.0.id' => 'string',
            'reverb.apps.0.key' => 'string',
            'reverb.apps.0.secret' => 'string',
            'reverb.apps.0.options.host' => 'string',
            'reverb.apps.0.options.port' => 'string',
            'reverb.apps.0.options.scheme' => 'string',
            'reverb.apps.0.options.useTLS' => 'boolean',
            'reverb.apps.0.allowed_origins' => 'array',
            'reverb.apps.0.ping_interval' => 'integer',
            'reverb.apps.0.activity_timeout' => 'integer',
            'reverb.apps.0.max_connections' => 'NULL',
            'reverb.apps.0.max_message_size' => 'integer',
            'reverb.apps.0.accept_client_events_from' => 'string',
...
'join','invite','removeMember','updateMemberRole',);
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\wamp64\\www\\Internship project\\intellmeet\\public\\storage',
...
'reverb.servers.reverb.scaling.server.database','reverb.servers.reverb.pulse_ingest_interval','reverb.servers.reverb.telescope_ingest_interval','reverb.apps.0.id','reverb.apps.0.key',
'reverb.apps.0.secret','reverb.apps.0.options.host','reverb.apps.0.options.port','reverb.apps.0.options.scheme','reverb.apps.0.options.useTLS',
'reverb.apps.0.allowed_origins','reverb.apps.0.ping_interval','reverb.apps.0.activity_timeout','reverb.apps.0.max_connections','reverb.apps.0.max_message_size',
'reverb.apps.0.accept_client_events_from','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
...
'sanctum.csrf-cookie',
'login','register','login.post','register.post','password.request',
'password.email','password.reset','password.update','logout',
'dashboard','meetings.analytics','notifications.json','notifications.mark-read','notifications.mark-all-read',
'components.index','notifications.unread-count','teams.members.json','meetings.popup','meetings.join.by-code',
'meetings.video-room','meetings.participant-name','meetings.join','meetings.end','meetings.invite-link',
'meetings.add-participant','action-items.complete','meetings.index','meetings.create','meetings.store',
'meetings.show','meetings.edit','meetings.update','meetings.destroy','my-tasks',
'api.tasks','tasks.update-status','tasks.index','tasks.create','tasks.store',
'tasks.show','tasks.edit','tasks.update','tasks.destroy','tasks.upload-attachment',
'tasks.delete-attachment','tasks.download-attachment','teams.members','teams.addMember','teams.removeMember',
'teams.updateMemberRole','teams.invite','teams.leave','teams.transfer','teams.index',
'teams.create','teams.store','teams.show','teams.edit','teams.update',
'teams.destroy','teams.acceptInvite','profile.show','profile.edit','profile.update',
'profile.destroy','settings.index','settings.update-profile','settings.update-password','settings.update-notifications',
'settings.upload-avatar','settings.remove-avatar','ai.process','ai.process-text','ai.insights',
'admin.users.index','admin.users.create','admin.users.store','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.users.restore','admin.users.forceDelete','admin.users.bulkDelete',
'admin.users.bulkRestore','admin.users.toggleStatus','admin.users.changeRole','check.auth','storage.local','storage.local.upload',);
...
'teams.index','teams.members','teams.show','welcome','laravel-exceptions-renderer::components.badge',
...
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.wamp64.www.Internship project.intellmeet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'SESSION_DOMAIN','SESSION_SECURE_COOKIE','SESSION_SAME_SITE','REDIS_HOST','REDIS_PASSWORD',
'REDIS_PORT','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','OPENAI_API_KEY',
'OPENAI_ORGANIZATION','OPENAI_MAX_TOKENS','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION',
...
'REVERB_PORT','REVERB_SCHEME','VITE_PUSHER_APP_KEY','VITE_PUSHER_APP_CLUSTER',);
