    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="text-sm text-gray-800">Meeting "Weekly Sync" completed</p>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="text-sm text-gray-800">5 action items extracted from recent meeting</p>
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl shadow-sm p-6 text-white">
                ...
                <p class="text-indigo-100 mb-4">Your team saved 12 hours this week using AI summaries</p>
                <div class="flex items-center justify-between">
                    <div>
